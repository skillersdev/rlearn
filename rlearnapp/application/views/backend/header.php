    ...
    <div class="container-fluid">
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <a href="<?php echo site_url(strtolower($this->session->userdata('role')).'/manage_profile'); ?>" class="dropdown-item notify-item">
             ...
             <?php if($admin_details['user_type']==2){ ?>
...
<div class="visit_website">
    ...
    <select class="language_selector btn btn-outline-light ml-3" onchange="switch_language(this.value)">
                <?php
   ...
   <!-- language switching code ends here-->
