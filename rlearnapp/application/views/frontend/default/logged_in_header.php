        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <?php
                    //echo $user_details['is_instructor'];  echo get_settings('allow_instructor'); 
                    //echo $this->session->userdata('is_instructor');
                    
                    if (get_settings('allow_instructor') == 1 && ($user_details['user_type']==1 ||$user_details['user_type']==2 || $user_details['user_type']==3)): ?>
