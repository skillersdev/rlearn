                          ...
                          <div class="content-box">
                              <div class="basic-group">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name = "email" id="login-email" placeholder="<?php echo get_phrase('email'); ?>" required>
                                  </div>
                                  <div class="form-group">
                          ...
                          <div class="content-box">
                              <div class="basic-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name = "email" id="registration-email" placeholder="<?php echo get_phrase('email'); ?>" value="" required>
                                  </div>
                                  <div class="form-group">
